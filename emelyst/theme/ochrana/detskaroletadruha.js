Vue.component('detskaroletadva', {
  data() {
    return {
      ...
      subscription: {
        topic: "EMELYST/poschodie/izba/motorcek2",
        qos: 0
      },
      publish: {
        topic: "EMELYST/poschodie/izba/motorcek2",
  ...
  template: `<div class="mt-md-2 mt-3"><p>detská izba dva</p>
  <div class="img mb-2">
    <img
      :src="imageState2"
      alt="roleta"
