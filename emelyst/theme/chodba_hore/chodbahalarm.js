Vue.component('chodbahalarm', {
  data() {
    return {
      ...
      subscription: {
        topic: "EMELYST/poschodie/chodba/alarm",
        qos: 0
      },
      publish: {
        topic: "EMELYST/poschodie/chodba/alarm",
  ...
  template: `<div><h2 class="py-4">alarm</h2>
  <div class="mb-2 img">
    <img :src="imageState2" alt="alarm" />
  </div>
  <button
    type="button"
    @click="btnChange2"
