Vue.component('spalnahsatniksvetlo', {
  data() {
    return {
      activated2: true,
      connection: {
      ...
      subscription: {
        topic: "EMELYST/poschodie/satnik/svetlo",
        qos: 0
      },
      publish: {
        topic: "EMELYST/poschodie/satnik/svetlo",
  ...
  template: `<div>
  <div class="mb-2">
    <img :src="imageState2" alt="satnik" />
  </div>
  <button
    type="button"
    @click="btnChange2"
    class="btn btn-light mt-4 mb-4"
    :class="{ btnYellow: activated2 == true }"
  >
    {{ activated2 == false ? "zapnúť" : "vypnúť" }}
  </button></div>`
})

new Vue({
  el: '#spalnaHSatnikSvetlo'
})
